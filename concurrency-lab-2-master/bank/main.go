...
//a go routine which will schedule the transactions for each worker.
func manager(bank *bank, transactionQueue <-chan transaction, done chan<- bool) {
...
func main() {
	...
	go manager(&bank, transactionQueue, done)
